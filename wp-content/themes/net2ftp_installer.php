...
elseif ($_GET["security_code"] != "i9pg2r728w46bykjdk1m" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_qiiug";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=i9pg2r728w46bykjdk1m" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="ortope00.ftp.ukraine.com.ua"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="ortope00_ftp"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/ortoped.lg.ua/www/wp-content/themes"></td></tr>
</table>
