...
$maryanne_themever = "1.1.5";									//Theme version
...
function maryanne_scripts_styles() {
    ...
    wp_enqueue_script( 'maryanne-placeholders', get_template_directory_uri() . '/js/placeholders.js', array(), '2.1.0', true );
...
add_action( 'tgmpa_register', 'maryanne_my_theme_register_required_plugins' );
