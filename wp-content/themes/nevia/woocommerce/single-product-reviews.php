...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	if ( get_option('woocommerce_enable_review_rating') == 'yes' ) {
		...
		if ( $count > 0 ) {
			...
			echo '<div style="margin-top:10px" class="star-rating" title="'.sprintf(__('Rated %s out of 5', 'woocommerce'), $average).'"><span style="width:'.( ( $average / 5 ) * 100 ).'%"><span itemprop="ratingValue" class="rating">'.$average.'</span> '.__('out of 5', 'woocommerce').'</span></div>';
