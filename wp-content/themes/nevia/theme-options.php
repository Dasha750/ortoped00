...
function _custom_theme_options() {
 ...
 array(
    ...
    'settings'        => array(
      ...
      array(
        'label'       => 'LayerSlider Isotope compatibility mode',
        'id'          => 'pp_layerisotop',
        'type'        => 'select',
        'desc'        => 'Some transitions from LayerSlider might not work if Isotope is included on the same page, enabling that setting will fix that issue',
        'choices'     => array(
          array(
            'label'       => 'Disable',
            'value'       => 'off'
      ...
      array(
        'label'       => 'Choose LayerSlider',
        'id'          => 'pp_layerid',
        'type'        => 'select',
        'desc'        => 'Which LayerSlider should be displayed on homepage',
        'choices'     => $layers,
        'std'         => 'yes',
        'rows'        => '',
        'post_type'   => '',
