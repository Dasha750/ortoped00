...
<!-- 960 Container -->
<div class="container <?php if($layout !='full-width') echo 'floated'; ?> main">
  ...
  <div class="<?php if($layout !='full-width') {
    echo 'floated eleven';
    if($layout =="left-sidebar") echo ' right';
  } else {
                ...
                <section class="flexslider">
                  <ul class="slides post-img">
                    <?php while ( $sliderquery->have_posts() ) {
                     ...
                     ?>
                     <li>
                      <a href="<?php echo $attachment[0] ?>" rel="fancybox-gallery" title="<?php echo $image->post_title; ?>" >
                ...
                <?php
                  ...
                  if($format == 'video') {
                    ...
                    <section class="post-content">
                      <header class="meta">
                        <h1><a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'purepress'), the_title_attribute('echo=0')); ?>" rel="bookmark">
                          <?php the_title(); ?>
                        </a></h1>
                        <?php nevia_posted_on(); ?>
                      </header>
