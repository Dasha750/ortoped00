        ...
        init : function(ed) {
            ...
            output = '';
                ...
                insert : function() {
                    ...
                    var cclas = jQuery('input.cclas').val();
                    output = '[column width="'+width+'" place="'+place+'" custom_class="'+cclas+'" ] '+ ListsDialog.local_ed.selection.getContent() + ' [/column] ';
                ...
                <div id="lists" class="dialogbox">
                    ...
                    <p>
                      ...
                      <p>
                            ...
                            <input class="cclas" name="cclas" type="text"/><br/>
                            <small>You can add custom class to column container</small>
                        </p>

                    <div class="desc">
                        <p>Full width page can be divided to 16 columns grid so while creating layouts keep in mind that sum of all columns in one row must be 16</p>
                        <p>For page/post with sidebar it's max 11 columns</p>
                    </div>
