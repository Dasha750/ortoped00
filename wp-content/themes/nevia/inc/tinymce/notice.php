...
<head>
    ...
    insert : function() {
            ...
            var text = jQuery('input.label').val();
            var content = $('.content').val();

            output += ' [notice title="'+title+'"  buttonlink="'+url+'" buttontext="'+text+'"] '+ content + ' [/notice] ';
        ...
        <div class="dialogbox"  id="tabs">
            <div class="tabcont">
                ...
                <p>
                    ...
                    <input class="url" name="tab" type="text" class="text" />
                </p> <p>
                    <label>Button label:</label>
                    <input class="label" name="tab" type="text" class="text" />
                </p>
